...
const Users = () => {
  ...
  return (
    <div className="relative bg-gray-100 min-h-screen">
      <header className="flex items-center justify-end px-4 md:hidden">
    ...
    <img
      ...
      <div className="p-1 md:p-5">
        ...
        <div className="flex flex-row md:justify-between md:items-center bg-white shadow p-2 rounded mb-6 gap-3 mt-5">
          ...
          <span className="hidden md:flex justify-center items-center text-gray-600 font-medium text-sm md:text-base">
            superadmin
          </span>
        </div>
