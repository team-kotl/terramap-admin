...
const Sidebar = () => {
    ...
    <ul className="space-y-8 mt-8 pl-4">
        ...
        <NavLink
            ...
            {({ isActive }) => (
            <>
                <LayoutDashboard size={20} className={isActive ? "text-green-800" : "text-gray-600"} />
                Dashboard
            </>
            )}
        </NavLink>
        ...
        <NavLink
            ...
            {({ isActive }) => (
            <>
                <Users size={20} className={isActive ? "text-green-800" : "text-gray-600"} />
                Users
            </>
            )}
        </NavLink>
        ...
        <NavLink
            ...
            {({ isActive }) => (
            <>
                <Map size={20} className={isActive ? "text-green-800" : "text-gray-600"} />
                Atlas Activity
            </>
            )}
        </NavLink>
        ...
        <NavLink
            ...
            {({ isActive }) => (
            <>
                <BarChart3 size={20} className={isActive ? "text-green-800" : "text-gray-600"} />
                Dashboard Activity
            </>
            )}
        </NavLink>
        ...
        <NavLink
            ...
            {({ isActive }) => (
            <>
                <DownloadCloud size={20} className={isActive ? "text-green-800" : "text-gray-600"} />
                Download
            </>
            )}
        </NavLink>
        ...
        <NavLink
            ...
            {({ isActive }) => (
            <>
                <SquarePen size={20} className={isActive ? "text-green-800" : "text-gray-600"} />
                CSS
            </>
            )}
        </NavLink>
    ...
    const UserSection = () => (
        <div onClick={() => setIsProfileOpen(true)} className="flex items-center gap-3 p-3 bg-green-800 rounded-lg cursor-pointer hover:bg-green-900 shadow">
